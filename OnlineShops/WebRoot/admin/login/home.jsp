...
<body class="main">
	...
	<div id="divpagecontent">
		<ul>
           ...
           <li><a class="active" href="#" style="text-align:center"><strong>后&nbsp;台&nbsp;销&nbsp;售&nbsp;中&nbsp;心</strong></a></li>         
           <li><a href="${pageContext.request.contextPath}/listProduct" target="mainFrame" style="text-align:center">商&nbsp;品&nbsp;管&nbsp;理</a></li>
           <li><a href="${pageContext.request.contextPath}/admin/products/download.jsp" target="mainFrame" style="text-align:center">销&nbsp;售&nbsp;榜&nbsp;单</a></li>
           <li><a href="${pageContext.request.contextPath}/findOrders" target="mainFrame" style="text-align:center">订&nbsp;单&nbsp;管&nbsp;理</a></li>
           ...
           <li><a href="${pageContext.request.contextPath}/logout?type=admin" onclick="javascript:return confirm_logout()" style="text-align:center">退&nbsp;出&nbsp;登&nbsp;录</a></li>
        </ul>
	</div>
	<div class="divcontent_2">
	     ...
	     <p><b style="font-size:23px">欢迎来到OnlineShop，这里是你的销售中心，让我们一起用科技点亮未来吧！</b></p>
	</div>
</body>
</html>
